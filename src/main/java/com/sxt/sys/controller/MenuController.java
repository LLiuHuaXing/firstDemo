...
public class MenuController {
	...
	*/
	 ...
	 * @return
	 */
	@RequestMapping("updateMenuAvailable")
	public ResultObj updateMenuAvailable(@Valid PermissionVo permissionVo,BindingResult bindingResult) {
		//数据校证
		...
		try {
			...
			permissionService.updateMenuAvailable(permissionVo);
	...
	public ResultObj addMenu(@Valid PermissionVo permissionVo, BindingResult bindingResult) {
		//数据校证
		if(bindingResult.hasErrors()){
			String errorInfo="";
			for (FieldError fieldError:bindingResult.getFieldErrors()){
