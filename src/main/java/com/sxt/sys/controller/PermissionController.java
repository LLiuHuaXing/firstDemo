...
public class PermissionController {
    ...
    public ResultObj addPermission(@Valid PermissionVo permissionVo, BindingResult bindingResult) {
        //数据校证
    ...
    public ResultObj updatePermission(@Valid PermissionVo permissionVo, BindingResult bindingResult) {
        //数据校证
        if(bindingResult.hasErrors()){
            String errorInfo="";
            for (FieldError fieldError:bindingResult.getFieldErrors()){
