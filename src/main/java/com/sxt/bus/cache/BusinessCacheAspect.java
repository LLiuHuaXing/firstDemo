...
public class BusinessCacheAspect {
	...
	//商品数据的缓存 声明切面表达式
	    ...
	    private static final String POINTCUT_GOODS_BATCHDELETE = "execution(* com.sxt.bus.service.impl.GoodsServiceImpl.removeByIds(..))";
	...
	public Object cacheGoodsBatchDelete(ProceedingJoinPoint joinPoint) throws Throwable {
		// 取出第一个参数
		@SuppressWarnings("unchecked")
		Collection<Serializable> idList = (Collection<Serializable>) joinPoint.getArgs()[0];
		Boolean isSuccess = (Boolean) joinPoint.proceed();
