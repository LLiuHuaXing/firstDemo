...
public class InportController {
	...
	public ResultObj addInport(@Valid InportVo inportVo, BindingResult bindingResult) {
		//数据校证
	...
	public ResultObj updateInport(@Valid InportVo inportVo, BindingResult bindingResult) {
		//数据校证
		if(bindingResult.hasErrors()){
			String errorInfo="";
			for (FieldError fieldError:bindingResult.getFieldErrors()){
